...
angular
	...
	.config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider', function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
		...
		$stateProvider
			...
			.state('bet.admin_onlinesales', {
				url: '/admin/onlineusers',
				templateUrl: 'views/admin/bets/onlineusers.html',
					...
					loadMyFiles: function ($ocLazyLoad) {
						return $ocLazyLoad.load({
							...
							files: [
								'scripts/services/userinfo.js',
								'scripts/directives/summary/summary.js',
								'scripts/controllers/admin/bets/onlineusers.js',
							]
						})
					}
				}
			...
			.state('bet.user_accountbal', {
				url: '/user/user_accountbal',
				templateUrl: 'views/user/accountbal.html',
				controller: 'AccountBalCtrl',
				resolve: {
					loadMyFiles: function ($ocLazyLoad) {
						return $ocLazyLoad.load({
							name: 'betting',
							files: [
								'scripts/services/userinfo.js',
								'scripts/controllers/user/accountbal.js',
							]
						})
					}
				}
			})
			.state('bet.user_winlist', {
				url: '/user/user_winlist',
				templateUrl: 'views/user/winlist.html',
					...
					loadMyFiles: function ($ocLazyLoad) {
						return $ocLazyLoad.load({
							...
							files: [
								'scripts/services/userinfo.js',
								'scripts/directives/summary/summary.js',
								'scripts/controllers/user/winlist.js',
							]
						})
					}
				}
