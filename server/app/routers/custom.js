...
router.post('/user/user_save_commission', user.user_save_commission);
...
router.post('/setting/set_option', setting.set_option);
...
router.post('/terminal/credit_remove', terminal.credit_remove);
...
router.post('/bet/online_sales', bet.online_sales);
router.post('/bet/summary_user', bet.summary_user);

router.post('/bet/summary_online', bet.summary_online);
...
router.post('/bet/clear_selected_bets', bet.clear_selected_bets);
...
router.post('/pos/reset', pos.reset);
router.post('/pos/ticket_list', pos.ticket_list);
router.post('/pos/bet_counts', pos.bet_counts);
